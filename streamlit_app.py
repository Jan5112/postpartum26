...
if all_df is not None:
    ...
    if st.session_state.view == 'details':
        ...
        <div class="recipe-card">
            ...
            <p><span class="meal-label">🛒 準備食材：</span><br>{r['Ingredients']}</p>
            <p><span class="meal-label">👩‍🍳 烹飪步驟：</span><br>{r['Method']}</p>
        </div>
        """, unsafe_allow_html=True)
